...
export default function DailyRecipe() {
    ...
    useEffect(() => {
        async function getRecipe() {
            const data = await getDailyRecipe()
            setRecipe(data)
        }
                ...
                >
                    ...
                    <div className="flex gap-16 justify-between items-end">
                        <div className="flex flex-col">
                            <h2
                                className="text-3xl font-bold text-white bg-primary-base border-b-0 rounded-sm  group-hover:border-b-4 group-hover:rounded group-hover:rounded-t-sm border-primary-light px-4 py-1 transition-all duration-150">
